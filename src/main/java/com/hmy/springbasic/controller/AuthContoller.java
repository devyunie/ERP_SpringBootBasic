...
import com.hmy.springbasic.service.AuthService;
...
public class AuthContoller {
    ...
    public String getAuth(
        ...
        // 인증에 실패한 접근 주체일 경우 anonymousUser를 반환함, 단 해당 url 패턴이 permitAll 일대만 가져옴
    ...
    public String signIn(
        ...
        String response = authService.signIn(requestDto);
        return response;
    };
